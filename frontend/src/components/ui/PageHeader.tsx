  ...
  return (
    <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, marginBottom: 24 }}>
      <div style={{ minWidth: 0 }}>
        <h1 style={{ color: C.text, fontSize: 26, fontWeight: 700, margin: 0, lineHeight: 1.2 }}>{title}</h1>
        {subtitle && <div style={{ color: C.muted, fontSize: 14, marginTop: 6 }}>{subtitle}</div>}
      </div>
